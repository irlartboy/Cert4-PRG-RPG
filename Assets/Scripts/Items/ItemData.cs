    ...
    public static Item CreateItem(int itemID)
    {
        ...
        switch (itemID)
        {
            ...
            case 202:
                ...
                _value = 20;
                _description = "a hat";
                _icon = "Apperal/ChestPiece_Icon";
                _mesh = "Apperal/ChestPiece_Mesh";
                _type = ItemType.Apparel;
                _armour = 5;
                _amount = 1;
                break;
            case 203:
                ...
                _value = 20;
                _description = "a hat";
                _icon = "Apperal/Boots_Icon";
                _mesh = "Apperal/Boots_Mesh";
                _type = ItemType.Apparel;
                _armour = 5;
                _amount = 1;
                break;
            ...
            case 502:
                ...
                _mesh = "Ingredients/Musroom_Mesh";
                _type = ItemType.Ingredient;
                _amount = 1;
                break;
            #endregion
        ...
        Item temp = new Item
        {
            ...
            Icon =  Resources.Load("Prefabs/"+_icon) as Texture2D, 
            Mesh = Resources.Load("Prefabs/"+ _mesh) as GameObject,
            Type = _type,
            Heal = _heal,
            Damage = _damage,
            Armour = _armour,
